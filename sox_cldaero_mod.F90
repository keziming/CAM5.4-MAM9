...
!   added by kzm
    integer :: id_so4_7a,id_so4_8a 
    integer :: id_nh4_7a,id_nh4_8a 
!------------
    integer :: l,n
    integer :: i,k
...
!  added by kzm
    elseif (mode9) then
       ...
       id_so4_5a = lptr_so4_cw_amode(6) - loffset
       id_so4_6a = lptr_so4_cw_amode(7) - loffset
       id_so4_7a = lptr_so4_cw_amode(8) - loffset
       id_so4_8a = lptr_so4_cw_amode(9) - loffset
       ...
       id_nh4_5a = lptr_nh4_cw_amode(6) - loffset
       id_nh4_6a = lptr_nh4_cw_amode(7) - loffset
       id_nh4_7a = lptr_nh4_cw_amode(8) - loffset
       id_nh4_8a = lptr_nh4_cw_amode(9) - loffset
#endif 
        conc_obj%so4c(:ncol,:) &
            = qcw(:ncol,:,id_so4_1a) &
            + qcw(:ncol,:,id_so4_2a) &
