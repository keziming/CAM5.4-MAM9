...
! added by kzm
integer :: mode_coarse_dst1_idx = -1  ! index of coarse dust mode 
integer :: mode_coarse_dst2_idx = -1  ! index of coarse dust mode 
integer :: mode_coarse_dst3_idx = -1  ! index of coarse dust mode 
!-------------------------------------
...
subroutine nucleate_ice_cam_init(mincld_in, bulk_scale_in)
   ...
   if (clim_modal_aero) then
      ...
      ! added by kzm
         case ('coarse_dust1') 
            mode_coarse_dst1_idx = m 
         case ('coarse_dust2')
            mode_coarse_dst_idx = m
         case ('coarse_dust3')
            mode_coarse_dst3_idx = m
      !---------------------
         end select
      end do
      ...
      if (mode_coarse_dst1_idx > 0) then
         separate_dust = .true.
      endif
