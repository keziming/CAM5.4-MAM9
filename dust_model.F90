...
! added by kzm
  ...
  integer, parameter :: dust_nnum = 4
  character(len=6), parameter :: dust_names(dust_nbin+dust_nnum) = (/ 'dst_a5', 'dst_a7', 'dst_a8',&
                                  'dst_a9','num_a5', 'num_a7', 'num_a8', 'num_a9' /)
  real(r8),         parameter :: dust_dmt_grd(dust_nbin+1) = (/ 0.1e-6_r8, 1.0e-6_r8, 2.5e-6_r8, &
                                   5.0e-6_r8, 10.0e-6_r8/)
  real(r8),         parameter :: dust_emis_sclfctr(dust_nbin) = (/ 0.038_r8, 0.11_r8, 0.17_r8, 0.67_r8/)
!--------------------
